...
fig = px.bar(total_pop, x="age_group", y="counts",  color="sex", barmode='group', animation_frame="date"
             ,labels={"age_group": "Age Group", "counts": "Number of people diagnosed with Covid-19"}
            )
